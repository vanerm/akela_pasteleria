        ...
        <section id="preguntasfrecuentes">
            <div class="jumbotron" >
                <div class="container">
                    <div class="col-md-12">
                        <br/>
                        <img class="img-responsive"src="images2/preguntasfoto.jpg" style="width:100%">
                        <div class="caption">
                        </div>
                        <br/>
                    </div>
                    ...
                    <div class="container">
                    <h2 id="productos"><strong> Preguntas Frecuentes</strong></h2>
                </div>
            </div>
        </section>
    </div>
    ...
    <div class="panel-group" id="accordion">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 id="productos" class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse1"><b>¿Quiénes somos?</b> </a>
                </h4>
            </div>
            <div id="collapse1" class="panel-collapse collapse in">
                <div id="productos" class="panel-body">Ade Guardone es una Pastelería clásica con un giro personal. También tenemos opciones sin TACC. Estamos en Acassuso, Martínez, San Isidro. </div>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 id="productos" class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse2"><b>¿Cómo realizo una compra?</b></a>
                </h4>
            </div>
            <div id="collapse2" class="panel-collapse collapse">
                <div id="productos" class="panel-body">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 id="productos" class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse3"><b>¿Cuáles son los métodos de envío?</b></a>
                </h4>
            </div>
            <div id="collapse3" class="panel-collapse collapse">
                <div id="productos" class="panel-body">Tenemos servicio de entrega en domicilio.</div>
            </div>
        </div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 id="productos" class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse4"><b>¿Cuál es el costo del servicio de entrega?</b></a>
                </h4>
            </div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 id="productos" class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse5"><b>¿Cuáles son los medios de pago?</b></a>
                </h4>
            </div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 id="productos" class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse6"><b>¿Puedo tener seguimiento de mi pedido?</b></a>
                </h4>
            </div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 id="productos" class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse7"><b>¿Puedo solicitar una decoracion en particular para mi torta?</b></a>
                </h4>
            </div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 id="productos" class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse8"><b>¿Hacen catering para eventos?</b></a>
                </h4>
            </div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 id="productos" class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapse9"><b>¿Hay un importe mínimo de compra?</b></a>
                </h4>
            </div>
